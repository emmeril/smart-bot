    ...
    const buildLiveStatusPayload = async () => {
        ...
        const activePositions = getActivePositionEntries().map(([positionKey, position]) => {
            ...
            return {
                ...
                trailingActivateATR: Number.isFinite(position.trailingActivateATR) ? position.trailingActivateATR : null,
                trailingOffsetATR: Number.isFinite(position.trailingOffsetATR) ? position.trailingOffsetATR : null,
