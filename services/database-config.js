...
const Config = sequelize.define("Config", {
    ...
    riskRewardRatio: { type: DataTypes.FLOAT, defaultValue: 1.6 },
    trailingEnabled: { type: DataTypes.BOOLEAN, defaultValue: true },
    autoStopLossEnabled: { type: DataTypes.BOOLEAN, defaultValue: true },
    stopLossAtrMultiplier: { type: DataTypes.FLOAT, defaultValue: 1.6 },
    stopLossMinPercent: { type: DataTypes.FLOAT, defaultValue: 2.5 },
    stopLossMaxPercent: { type: DataTypes.FLOAT, defaultValue: 10 },
    autoTargetProfitEnabled: { type: DataTypes.BOOLEAN, defaultValue: true },
    targetProfitAtrMultiplier: { type: DataTypes.FLOAT, defaultValue: 2.4 },
    targetProfitMinUsdt: { type: DataTypes.FLOAT, defaultValue: 0.25 },
    targetProfitMaxUsdt: { type: DataTypes.FLOAT, defaultValue: 5 },
    trailingActivateATR: { type: DataTypes.FLOAT, defaultValue: 1.5 },
    trailingOffsetATR: { type: DataTypes.FLOAT, defaultValue: 0.75 },
    entryRsiPeriod: { type: DataTypes.INTEGER, defaultValue: 14 },
    entryRsiLongThreshold: { type: DataTypes.FLOAT, defaultValue: 40 },
    entryRsiShortThreshold: { type: DataTypes.FLOAT, defaultValue: 60 },
    entryAdxPeriod: { type: DataTypes.INTEGER, defaultValue: 14 },
    entryAdxMax: { type: DataTypes.FLOAT, defaultValue: 32 },
    entryBbPeriod: { type: DataTypes.INTEGER, defaultValue: 20 },
    entryBbStdDev: { type: DataTypes.FLOAT, defaultValue: 2 },
    entryBbLongThreshold: { type: DataTypes.FLOAT, defaultValue: 0.2 },
    entryBbShortThreshold: { type: DataTypes.FLOAT, defaultValue: 0.8 },
