    ...
    const analyzeSignal = async () => {
        try {
            ...
            return {
                ...
                marketContext: {
                    currentOpen: snapshot.currentOpen,
                    currentPrice: snapshot.currentPrice,
                    currentVolume: snapshot.currentVolume,
                    avgVolume: snapshot.avgVolume,
                    currentATR: snapshot.currentATR,
                    currentNatrPercent: snapshot.currentNatrPercent,
                    volumeRatio: snapshot.volumeRatio,
                    currentStdDev: snapshot.currentStdDev,
                    currentRsi: snapshot.currentRsi,
                    currentAdx: snapshot.currentAdx,
                    bbBasis: snapshot.bbBasis,
                    bbUpper: snapshot.bbUpper,
                    bbLower: snapshot.bbLower,
                    bbWidth: snapshot.bbWidth,
                    bbPercentB: snapshot.bbPercentB,
